...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Create Slot', href: '/admin/ad-slots/create' },
];
...
export default function CreateAdSlot() {
    ...
    const submit = (e: React.FormEvent) => {
        ...
        form.post('/admin/ad-slots');
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Create Ad Slot" />

            <div className="p-6">
                <Card>
                    <CardHeader><CardTitle>Create Ad Slot</CardTitle></CardHeader>
                    <CardContent>
